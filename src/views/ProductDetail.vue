  ...
  <div class="home">
    ...
    <div class="product-container">
      ...
      <div class="image-section">
        <img :src="selectImg" :alt="products.name" class="main-image" />
        <!-- 썸네일 -->
        <div class="thumbnails">
          <img v-for="(img, i) in product.images" :key="i" :src="img" @click="selectImg = img" class="thmb" />
        </div>
      </div>
      <!-- 상품 정보 -->
    ...
    <div v-if="showModal" class="modal-overlay" @click="showModal = false">
      <div class="modal-content">
        ...
        <div class="buttons">
          ...
          <button class="buy" @click="confrimBtn">확인</button>
        </div>
      </div>
    </div>
    <!-- 상세정보 / 리뷰 -->
